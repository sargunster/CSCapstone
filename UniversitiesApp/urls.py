...
urlpatterns = [
    ...
    url(r'^university/course/adds$', views.addStudentToCourse, name="AddStudentToCourse"),
    url(r'^university/course/removes$', views.removeStudentFromCourse, name="removeStudentFromCourse"),
